 ...
 * @author 
 * @email 
 * @date 2025-03-19 22:48:39
 */
@TableName("discussyundongzhishi")
public class DiscussyundongzhishiEntity<T> implements Serializable {
	private static final long serialVersionUID = 1L;


	public DiscussyundongzhishiEntity() {
		
	}
	
	public DiscussyundongzhishiEntity(T t) {
		try {
