		...
		>
			<template >
				...
				<el-form-item class="input" v-if="type!='info'"  label="身高" prop="shengao" >
					<el-input-number v-model="ruleForm.shengao" placeholder="身高" :disabled="ro.shengao"></el-input-number>
				</el-form-item>
				...
				<el-form-item class="input" v-if="type!='info'"  label="体重" prop="tizhong" >
					<el-input-number v-model="ruleForm.tizhong" placeholder="体重" :disabled="ro.tizhong"></el-input-number>
				</el-form-item>
	...
	export default {
		...
		methods: {
			...
			async onSubmit() {
					...
					if(((this.ruleForm.yonghuzhanghao).toString().length>16)){
					...
					if(((this.ruleForm.mima).toString().length>16)){
