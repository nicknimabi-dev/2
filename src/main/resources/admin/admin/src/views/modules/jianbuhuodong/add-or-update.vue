	...
	<div class="addEdit-block">
		...
		>
			<template >
				...
				<el-form-item class="input" v-if="type!='info'"  label="参与人数" prop="huodongminge" >
					<el-input v-model.number="ruleForm.huodongminge" placeholder="参与人数" clearable  :readonly="ro.huodongminge"></el-input>
				</el-form-item>
				<el-form-item v-else class="input" label="参与人数" prop="huodongminge" >
					<el-input v-model="ruleForm.huodongminge" placeholder="参与人数" readonly></el-input>
				</el-form-item>
			</template>
			<el-form-item v-if="type!='info'"  label="活动路线" prop="huodongluxian" >
				<editor 
					style="min-width: 200px; max-width: 600px;"
					v-model="ruleForm.huodongluxian" 
					class="editor"
					myQuillEditor="huodongluxian"
					action="file/upload">
				</editor>
			</el-form-item>
			<el-form-item v-else-if="ruleForm.huodongluxian" label="活动路线" prop="huodongluxian" >
				<span class="text ql-snow ql-editor" v-html="ruleForm.huodongluxian"></span>
			</el-form-item>
			...
			init(id,type) {
				...
				if(this.type=='info'||this.type=='else'||this.type=='msg'){
					...
					for (var o in obj){
						...
						if(o=='huodongluxian'){
							this.ruleForm.huodongluxian = obj[o];
							this.ro.huodongluxian = true;
							continue;
						}
						if(o=='thumbsupnum'){
					...
					this.ruleForm.huodongminge = Number('0'); 				}
				// 获取用户信息
				this.$http({
			...
			info(id) {
				this.$http({
					...
					if (data && data.code === 0) {
						...
						this.ruleForm.huodongluxian = this.ruleForm.huodongluxian.replace(reg,'../../../springbootdti6c7gx/upload');
					} else {
						this.$message.error(data.msg);
					}
				});
			...
			async onSubmit() {
					...
					await this.$refs["ruleForm"].validate(async valid => {
						if (valid) {
							...
							await this.$http({
								url: `jianbuhuodong/${!this.ruleForm.id ? "save" : "update"}`,
								method: "post",
								data: this.ruleForm
							}).then(async ({ data }) => {
								if (data && data.code === 0) {
									this.$message({
										...
										onClose: () => {
											...
											this.parent.jianbuhuodongCrossAddOrUpdateFlag = false;
											this.parent.search();
