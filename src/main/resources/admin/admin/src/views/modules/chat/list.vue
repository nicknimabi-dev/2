<template>
	<div class="main-content" :style='{"width":"100%","padding":"20px 30px","fontSize":"15px"}'>
		...
		<div v-if="!showFlag" style="width: 100%;">
			<el-form :style='{"border":"0px solid #fff","padding":"10px","margin":"0","flexWrap":"wrap","background":"#fff","display":"flex","width":"100%","justifyContent":"space-between"}' :inline="true" :model="searchForm" class="center-form-pv">
				<el-row :style='{"padding":"10px","alignItems":"center","flexWrap":"wrap","background":"none","display":"flex"}'>
					...
					<el-button class="search" :style='{"border":"0","cursor":"pointer","padding":"0 15px 0 10px","color":"#fff","borderRadius":"4px","background":"#03b6be","width":"auto","fontSize":"16px","minWidth":"90px","height":"40px"}' type="success" @click="search()">
				...
				<el-table
					...
					<el-table-column
						...
						<template slot-scope="scope">
							<el-button
								type="text"
								:style='{"border":"1px solid #21c79260","cursor":"pointer","padding":"0 10px","margin":"0 5px 5px 0","color":"#21c792","borderRadius":"4px","background":"rgba(255,255,255,.3)","width":"auto","fontSize":"14px","height":"32px"}'
								size="small"
