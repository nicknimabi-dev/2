	...
	<div class="addEdit-block">
		...
		>
			<template >
				...
				<el-form-item class="input" v-if="type!='info'"  label="计划用时" prop="jihuayongshi" >
					<el-input v-model="ruleForm.jihuayongshi" placeholder="计划用时" clearable  :readonly="ro.jihuayongshi"></el-input>
				</el-form-item>
				<el-form-item v-else class="input" label="计划用时" prop="jihuayongshi" >
					<el-input v-model="ruleForm.jihuayongshi" placeholder="计划用时" readonly></el-input>
				</el-form-item>
				<el-form-item class="input" v-if="type!='info'"  label="打卡次数" prop="dakacishu" >
					<el-input v-model.number="ruleForm.dakacishu" placeholder="打卡次数" clearable  :readonly="ro.dakacishu"></el-input>
				</el-form-item>
				<el-form-item v-else class="input" label="打卡次数" prop="dakacishu" >
			...
			init(id,type) {
				...
				if(this.type=='info'||this.type=='else'||this.type=='msg'){
					...
					for (var o in obj){
						...
						if(o=='jihuayongshi'){
							this.ruleForm.jihuayongshi = obj[o];
							this.ro.jihuayongshi = true;
							continue;
						}
						if(o=='dakacishu'){
					...
					this.ruleForm.dakacishu = Number('0'); 				}
				// 获取用户信息
				this.$http({
			...
			info(id) {
				this.$http({
					...
					if (data && data.code === 0) {
						...
						this.ruleForm.jihuaxiangqing = this.ruleForm.jihuaxiangqing.replace(reg,'../../../springbootdti6c7gx/upload');
					} else {
						this.$message.error(data.msg);
					}
				});
