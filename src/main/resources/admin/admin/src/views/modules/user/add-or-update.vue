	...
	<div class="addEdit-block">
		...
		>
			<template >
				...
				<el-form-item class="input" v-if="type!='info'"  label="身高" prop="height" >
					<el-input-number v-model="ruleForm.height" placeholder="身高" :disabled="ro.height"></el-input-number>
				</el-form-item>
				<el-form-item v-else class="input" label="身高" prop="height" >
					<el-input v-model="ruleForm.height" placeholder="身高" readonly></el-input>
				</el-form-item>
				<el-form-item class="input" v-if="type!='info'"  label="体重" prop="weight" >
					<el-input-number v-model="ruleForm.weight" placeholder="体重" :disabled="ro.weight"></el-input-number>
				</el-form-item>
				<el-form-item v-else class="input" label="体重" prop="weight" >
					<el-input v-model="ruleForm.weight" placeholder="体重" readonly></el-input>
				</el-form-item>
				...
				<el-form-item class="input" v-if="type!='info'"  label="密码错误次数" prop="passwordwrongnum" >
					<el-input v-model.number="ruleForm.passwordwrongnum" placeholder="密码错误次数" clearable  :readonly="ro.passwordwrongnum"></el-input>
				</el-form-item>
				<el-form-item v-else class="input" label="密码错误次数" prop="passwordwrongnum" >
...
<script>
	...
	export default {
		...
		methods: {
			...
			// 提交
			async onSubmit() {
					if(((this.ruleForm.useraccount).toString().length<3)){
						this.$message.error(`用户账号长度不能小于3`);
						return
					}
					if(((this.ruleForm.useraccount).toString().length>16)){
						this.$message.error(`用户账号长度不能大于16`);
						return
					}
					if(((this.ruleForm.password).toString().length<3)){
						this.$message.error(`密码长度不能小于3`);
						return
					}
					if(((this.ruleForm.password).toString().length>16)){
